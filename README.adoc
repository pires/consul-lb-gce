...
I1217 21:03:05.031059       1 main.go:53] Initializing cloud client [Project ID: my-project-id, Network: nomad-network, Allowed Zones: []string{"us-east1-d", "europe-west1-d", "asia-east1-c"}]..
...
W1217 21:04:20.966353       1 main.go:186] Creating instance [client-us-01.c.my-project-id.internal].
